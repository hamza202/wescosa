                ...
                <div class="slick-slider carousel-parent" id="parent-carousel" data-loop="true" data-dots="false" data-swipe="true" data-items="1" data-child="#child-carousel" data-for="#child-carousel">
                  <div class="item">
                    <div class="slick-image">
                      <div class="product-preview"><img src="images/DSC_0250.webp" alt="" width="226" height="284"/>
                      </div>
                    </div>
                  </div>
                  <div class="item">
                    <div class="slick-image">
                      <div class="product-preview"><img src="images/DSC_0253.NEF.webp" alt="" width="282" height="293"/>
                      </div>
                    </div>
                  </div>
                  <div class="item">
                    <div class="slick-image">
                      <div class="product-preview"><img src="images/DSC_0253.webp" alt="" width="338" height="256"/>
                      </div>
                    </div>
                  </div>
                  <div class="item">
                    <div class="slick-image">
                      <div class="product-preview"><img src="images/DSC_0250.webp" alt="" width="214" height="326"/>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="layout-horizontal__main"> 
              <article class="single-product">
                <div class="single-product__header">
                  <h3 class="single-product__title">Transformers</h3>
                </div>
                  ...
                  <div class="tabs-custom tabs-horizontal tabs-line">
                    ...
                    <div class="tab-content">
                      <div class="tab-pane fade in active" id="tabs-product-1">
                        <p>Transformers are offered in hermetically sealed design. The tank is designed to accommodate expansion of oil during loading through the use of corrugated steel sheets. The cover is bolted to the tank body and proper gaskets are provided to avoid leakages. Welded tank is also available.</p>
                      </div>
                    </div>
                  </div>
                  <div class="group group-buttons group-middle"><a class="button button-darker" href="">get a quote</a>
                    <a class="button button-primary" href="#">get price list</a>
                  </div>
                </div>
              </article>
            </div>
