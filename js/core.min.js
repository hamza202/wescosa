...
Math.abs(e-b)<a.core.s.swipeThreshold&&(a.thumbClickable=!0),a.left=d):a.thumbClickable=!0:a.thumbClickable=!0})};g.prototype.toogle=function(){var a=this;a.core.s.toogleThumb&&(a.core.$outer.addClass("lg-can-toggle"),a.$thumbOuter.append('<span class="fa fa-th lg-icon"></span>'),a.core.$outer.find(".fa-th").on("click.lg",function(){a.core.$outer.toggleClass("lg-thumb-open")}))};g.prototype.thumbkeyPress=function(){var a=this;$(window).on("keydown.lg.thumb",function(b){38===b.keyCode?
