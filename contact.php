...
<script type="text/javascript">
    ...
    var locations = [
        [' Buraidah' + '<br>' + 'Head Office' + '<br>' + 'Fax : +123456' +'<br> <br>'
        ...
        '<li><a class="icon icon-xs icon-style-modern fa fa-linkedin" href="#"></a></li>\n' +
        '</ul>', 26.3479206, 44.0635138, 7],

        [' Al-Dmam' + '<br>' + 'Head Office' + '<br>' + 'Fax : +123456' +'<br> <br>'
        +'<ul class="list-inline-xxs">' +
        '<li><a class="icon icon-xs icon-style-modern fa fa-twitter" href="#"></a></li>\n' +
        '<li><a class="icon icon-xs icon-style-modern fa fa-facebook" href="#"></a></li>\n' +
        '<li><a class="icon icon-xs icon-style-modern fa fa-linkedin" href="#"></a></li>\n' +
        '</ul>', 24.7253981, 47.3830368, 7],

        [' Makah' + '<br>' + 'Head Office' + '<br>' + 'Fax : +123456' +'<br> <br>'
        +'<ul class="list-inline-xxs">' +
        '<li><a class="icon icon-xs icon-style-modern fa fa-twitter" href="#"></a></li>\n' +
        '<li><a class="icon icon-xs icon-style-modern fa fa-facebook" href="#"></a></li>\n' +
        '<li><a class="icon icon-xs icon-style-modern fa fa-linkedin" href="#"></a></li>\n' +
        '</ul>', 21.4362767, 39.9866352, 7],

        ['AlMadinah AlMonawrah' + '<br>' + 'Head Office' + '<br>' + 'Fax : +123456' +'<br> <br>'
        +'<ul class="list-inline-xxs">' +
        '<li><a class="icon icon-xs icon-style-modern fa fa-twitter" href="#"></a></li>\n' +
        '<li><a class="icon icon-xs icon-style-modern fa fa-facebook" href="#"></a></li>\n' +
        '<li><a class="icon icon-xs icon-style-modern fa fa-linkedin" href="#"></a></li>\n' +
        '</ul>', 24.4714392, 39.8977597, 7]
    ];
