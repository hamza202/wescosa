...
<head>
    ...
    <link rel="stylesheet" href="js/icons/css/fontello.css">
...
<body>
 <div id="load_screen"><div id="loading">
     ...
     <img src="images/loader.png" class="" style="width:70px;height:auto;"/>
<br />
<br />
<div class="three col">
  <div class="loaderx" id="loader-6">
    <span></span>
    <span></span>
    <span></span>
    <span></span>
...
<div class="page">
        ...
        <div class="section-layout-aside">
            ...
            <div class="section-layout-aside__item">
                <figure class="snip1302">
                    ...
                    <figcaption>
                        <h2 class="text-uppercase">Outomation</h2>
                        <div class="icons">
                            <a href="#"><i class="ion-social-reddit-outline"></i></a>
                            <a href="#"> <i class="ion-social-twitter-outline"></i></a>
                            <a href="#"> <i class="ion-social-vimeo-outline"></i></a></div>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="section-md shell-fluid-cell">
                                <div class="box-centered box-width-1">
                                    ...
                                    <div class="group-md group-middle button-group"><a class="button button-darker forgetbuttonToEqulother"
    ...
    <section class="section parallax-container bg-gray-dark ">
        <div class="material-parallax parallax"><img src="images/sky-cable.jpg" alt=""
                                                     style="display: block; transform: translate3d(-50%, 7px, 0px);">
        </div>
        <div class="parallax-content">
            <div class="section-md text-center overlay-dark">
                        ...
                        <li class="list-blocks__item">
                            <div class="list-blocks__item-inner">
                                <article class="box-counter-modern">
                                    ...
                                    <p class="box-counter-modern__title">Supplier in KSA</p>
                                </article>
                            </div>
                        </li>
                        <li class="list-blocks__item">
    ...
    <section class="section section-md section-bottom-0 bg-white text-center">
        ...
        <div class="shell-fluid">
            <div class="range range-condensed range-md-reverse range-flex">
                <div class="cell-md-6 bg-gray-dark bg-image" style="background-image: url(images/video-preview-962x465.jpg);">
